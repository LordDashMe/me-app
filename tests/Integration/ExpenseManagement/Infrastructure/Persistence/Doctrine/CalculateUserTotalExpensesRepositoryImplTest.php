...
use ExpenseManagement\Infrastructure\Persistence\Repository\Doctrine\CalculateUserTotalExpensesRepositoryImpl;

class CalculateUserTotalExpensesRepositoryImplTest extends IntegrationTestBase
{
    ...
    public function it_should_calculate_persisted_user_total_expenses()
    {
        ...
        $persistence = new CalculateUserTotalExpensesRepositoryImpl($this->entityManager);
