...
use UserManagement\Application\Command\Handler\UserRegistrationCommandHandler;
...
class UserRegistrationTest extends TestCase
{
    ...
    {
        $command = Mockery::mock(UserRegistrationCommand::class);
        $repository = Mockery::mock(UserRegistrationRepository::class);
        $passwordEncoder = Mockery::mock(PasswordEncoder::class);
        $uniqueIDResolver = Mockery::mock(UniqueIDResolver::class);

        $commandHandler = new UserRegistrationCommandHandler(
            $command,
            $repository,
            $passwordEncoder,
            $uniqueIDResolver
        ...
        $this->assertInstanceOf(UserRegistrationCommandHandler::class, $commandHandler);
    }
